                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8  text-white">
                    <div className="neo overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-transparent  ">
                            ...
                            <Link href={route("users.create")} className="text-purple-500">Crear Nuevo Empleado</Link>
                                    ...
                                    {users.map((user) => (
                                        <tr key={user.id}>
                                            ...
                                            <td className="border px-4 py-2 flex">
                                                <Link href={route("users.edit", user.id)} className="editar text-blue-500 mr-2">Editar</Link>
                                                
                                                <button onClick={handleDelete} data-id={user.id} class="button">
                                                    <span>Eliminar
                                                    </span>
                                                    <span>
